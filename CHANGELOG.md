...
- Remove external tool references from CHANGELOG
  ([`3f96435`](https://github.com/dkdndes/cowboy-django/commit/3f9643546ed92ae86ddcc31594e7c9c1c37f6fc7))
...
- Release v2.1.0 with Git tag-based versioning
  ([#29](https://github.com/dkdndes/cowboy-django/pull/29),
  [`00193a4`](https://github.com/dkdndes/cowboy-django/commit/00193a460a587f17c2225c5d54a0dc8cf037ebf8))

* feat(jokes): add two new Kubernetes-themed cowboy jokes
...
* feat(version): use Git tags for versioning without file commits (#27)
...
* fix(ci): use stable semantic-release version and Git tag versioning (#28)
...
Co-authored-by: Claude <noreply@anthropic.com> Co-authored-by: semantic-release
  <semantic-release@users.noreply.github.com>
